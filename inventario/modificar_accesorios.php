      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand">Accesorios</a>
          </div>
            ...
            <div class="card ">
              ...
              <div class="card-body ">
               ...
               <?php
                ...
                $codbandeja=$_GET['codbandeja'];
                $codaccesorio = $_GET['cod'];
                $link = conectarse();

                $sql= "SELECT * from accesorio WHERE accesorio.codigoaccesorio= '$codaccesorio'";
                $rs = mysqli_query(conectarse(),$sql) or die("Fallo la consulta");
                $campo=mysqli_fetch_array($rs);
                ?>           
                    <form method="post" action="modificado_accesorios.php?codsala=<?php echo $codsala?>&codbandeja=<?php echo $codbandeja?>&cod=<?php echo $codaccesorio?>" enctype="multipart/form-data">
                    
                    <input type="hidden" name="codigoaccesorio"  value="<?php echo $codaccesorio;?>" required/>

                    <div class="form-group">
                    <label for="fechatraslado">Codigo Bandeja</label>
                    <input type="text" class="form-control" name="codigobandeja"  value="<?php echo $campo['codigobandeja']?>"/ readonly="readonly" required>                
                    </div>

                    <div class="form-group">
                    <label for="puntopartida">Código</label>
                    <input type="text" class="form-control" name="codigo" value="<?php echo $campo['codigo']?>"/ required>                  
                    </div>
                 
                    <div class="form-group">
                    <label for="puntollegada">Denominacion</label>
                    <input type="text" class="form-control" name="denominacion" value="<?php echo $campo['denominacion']?>"/ required>                  
                    </div>

                    <div class="form-group">
                    <label for="motivotraslado">Marca</label>
                    <input type="text" class="form-control" name="marca" value="<?php echo $campo['marca']?>"/ required>                  
                    </div>

                    <div class="form-group">
                    <label for="responsabletraslado">Modelo</label>
                    <input type="text" class="form-control" name="modelo" value="<?php echo $campo['modelo']?>"/ required>                  
                    </div>

                    <div class="form-group">
                    <label for="responsabletraslado">Serie</label>
                    <input type="text" class="form-control" name="serie" value="<?php echo $campo['serie']?>"/ required>                  
                    </div>
                    ...
                    <a class="btn btn-warning" href="listar_accesorios.php?codbandeja=<?php echo $codbandeja?>&codsala=<?php echo $codsala?>">Retroceder</a>

                    <center>
                        <input class="btn btn-primary" type="submit" value="Acctualizar Accesorio" name="enviar">
