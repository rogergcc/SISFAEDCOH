...
<!-- CONTENIDO -->
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                $nombresalatecnologica=$_POST['nombresalatecnologica'];
                $lugar=$_POST['lugar'];

                echo $nombresalatecnologica."<br>";
                echo $lugar."<br>";
                
                //nos conectamso a la BD y actualizamos el registro
                  $link = conectarse();
                  $sql="INSERT INTO salatecnologica (nombresalatecnologica, lugar) VALUES ('$nombresalatecnologica', '$lugar')";
                  $result = mysqli_query($sql,$link) or die("Fallo la consulta");
                
                 
                ?>     
                                  
                   <a class="btn btn-warning" href="listar_salastecnologicas.php">Retroceder</a>
