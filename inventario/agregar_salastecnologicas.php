      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand">Registro de Salas Tecnológicas FAEDCOH</a>
          </div>
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <section><!-- InstanceBeginEditable name="EditRegion1" -->
                    ...
                    <form method="post" action="ingresar_salastecnologicas.php" enctype="multipart/form-data">

              
                    <div class="form-group">
                    <label>Nombre de la Sala Tecnológica</label>
                    <input class="form-control" name="nombresalatecnologica" placeholder="Ingrese el nombre de la nueva sala tecnológica" required>
                    </div>
                      
                    <div class="form-group">
                    <label>Lugar de la Sala Tecnológica</label>
                    <input class="form-control" name="lugar" placeholder="Ingrese el lugar de la nueva sala tecnológica" required>
                    </div>
                    
                    <div class="form-group">
                        <td colspan="2" align="center">
                        <input class="btn btn-primary" type="submit" value="Registrar Nueva Sala Tecnológica" name="enviar">
                        </td>
                    </div>
