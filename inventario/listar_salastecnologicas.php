      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand">Listado de Salas Tecnologicas FAEDCOH</a>
          </div>
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                 ...
                 <section><!-- InstanceBeginEditable name="EditRegion1" -->
                  ...
                  <a type="btn btn-secondary" href="agregar_salastecnologicas.php" class="btn btn-secondary btn-lg btn-block" >Agregar una Nueva Sala Tecnologica</a>
                <br>
                <h2>Salas Tecnológicas</h2>
                  <?php
                  ...
                  ?>
                   ...
                   <?php
                   //enviar consulta
                   $instruccion = "SELECT * FROM salatecnologica";
