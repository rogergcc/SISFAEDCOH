...
<!-- CONTENIDO -->
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                $codigosalatecnologica=$_POST['codigosalatecnologica'];
                $nombrebandeja=$_POST['nombrebandeja'];
                $ubicacion=$_POST['ubicacion'];
                

                echo $codigosalatecnologica."<br>";
                echo $nombrebandeja."<br>";
                echo $ubicacion."<br>";
                
                //nos conectamso a la BD y actualizamos el registro
                  $link = conectarse();
                $nombrebandeja=$_POST['nombrebandeja'];
                  $sql="INSERT INTO bandeja (codigosalatecnologica, nombrebandeja, ubicacion) VALUES ('$codigosalatecnologica', '$nombrebandeja', '$ubicacion')";
                  $result = mysqli_query($sql,$link) or die("Fallo la consulta");
                
                 
                ?>     
                                  
                   <a class="btn btn-warning" href="listar_bandejas.php?cod=<?php echo $codigosalatecnologica?>">Retroceder a Bandejas</a>
