      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand">Registro de Accesorios</a>
          </div>
...
<!-- CONTENIDO -->
            ...
            <?php 
                ...
                $codigoaccesorio=$_POST['codigoaccesorio'];
              ...
              ?>
              <center>
               <a class="btn btn-warning" href="listar_accesorios.php?codbandeja=<?php echo $codbandeja?>&codsala=<?php echo $codsala?>">Regresar</a>
              </center>
              </div>
            </div>
<!-- FIN DEL CONTENIDO -->
