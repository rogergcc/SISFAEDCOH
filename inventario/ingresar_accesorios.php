...
<!-- CONTENIDO -->
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                $codigobandeja=$_POST['codigobandeja'];
                $codigo=$_POST['codigo'];
                ...
                ?>     
                   ...
                   <a class="btn btn-warning" href="listar_accesorios.php?codbandeja=<?php echo $codigobandeja?>&codsala=<?php echo $codigosala?>">Retroceder a Accesorios</a>
