      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand">Cod. Barras Accesorios</a>
          </div>
...
<!-- CONTENIDO -->
            <div class="card ">
              ...
              <div class="card-body ">
				...
				$instruccion = "SELECT codigoaccesorio FROM accesorio";
                   $rs = mysqli_query(conectarse(),$instruccion) or die("Fallo la consulta");
                   $n = mysqli_num_rows($rs);
                   while($codigoaccesorio = mysqli_fetch_array($rs)){
				?>
				<img src="barcode.php?text=<?php echo $codigoaccesorio['codigoaccesorio']; ?>&size=30&codetype=Code39&print=true" />
