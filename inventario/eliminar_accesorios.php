...
<!-- CONTENIDO -->
            <div class="card ">
              ...
              <?php            
                  ...
                  if(isset($codigo))
                  {
                    $instruccion="delete from accesorio where codigoaccesorio='$codigo'";
                ...
                ?>
                        <a class="btn btn-warning" href="listar_accesorios.php?codbandeja=<?php echo $codigobandeja?>&codsala=<?php echo $codigosala?>">Retroceder</a>
