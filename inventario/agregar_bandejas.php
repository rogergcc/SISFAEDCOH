      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand">Registro de Bandejas FAEDCOH</a>
          </div>
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <section><!-- InstanceBeginEditable name="EditRegion1" -->
                 ...
                 <form method="post" action="ingresar_bandejas.php" enctype="multipart/form-data">
                  ...
                  ?>
                   ...
                   <label> Código Sala Tecnológica</label>
                    <input class="form-control" name="codigosalatecnologica" value="<?php echo $codigo?>" readonly="readonly" required>
                    </div>         
                  ...
                  ?>
                    ...
                    <input class="form-control" name="nombrebandeja" placeholder="Ingrese el nombre de la nueva bandeja" required>
                    </div>
                      
                    <div class="form-group">
                    <label>Ubicación de la Bandeja</label>
                    <input class="form-control" name="ubicacion" placeholder="Ingrese la ubicacion de la nueva bandeja" required>
                    </div>
                    
                    <div class="form-group">
                        <td colspan="2" align="center">
                        <input class="btn btn-primary" type="submit" value="Registrar Nueva Bandeja" name="enviar">
                        </td>
                    </div>
