      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand">Guia de Remisión</a>
          </div>
...
<!-- CONTENIDO -->
            ...
            <?php 
                ...
                $codigoguiaremision=$_POST['codigo'];
                ...
                $sql="UPDATE guiaremision SET 
                  ...
                  WHERE codigoguiaremision='$codigoguiaremision'";
                  $rs = mysqli_query($link,$sql);
                
                  if($rs==1)
                  {
                  echo "<p class='titulo'>modificar Guia de Remision</p>";
              ...
              ?>
<center>
<a class="btn btn-warning" href="listar_guiaremision.php">Regresar</a>
</center>>
              </div>
            </div>
<!-- FIN DEL CONTENIDO -->
