  ...
  <div class="wrapper ">
    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          <li>
            <a href="../inventario/listar_inventario.php">
              <i class="now-ui-icons design_app"></i>
              <p>Inventario</p>
            </a>
          </li>
          <li>
            <a href="../audiovisuales/listar_salastecnologicas.php">
...
<!-- CONTENIDO -->
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                $responsabletraslado=$_POST['responsabletraslado'];
                ...
                //nos conectamso a la BD y actualizamos el registro
                  $link = conectarse();
                  $sql="INSERT INTO guiaremision (fechatraslado, puntopartida, puntollegada, motivotraslado, nombreaccesorio, responsabletraslado) VALUES ('$fechatraslado', '$puntopartida', '$puntollegada', '$motivotraslado', '$nombreaccesorio', '$responsabletraslado')";
                  $result = mysqli_query($sql,$link) or die("Fallo la consulta");
                ...
                ?>     
                   ...
                   <center><a class="btn btn-warning" href="listar_guiaremision.php">Retroceder</a></center>
