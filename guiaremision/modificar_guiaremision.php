      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand">Modificación de Guia de Remision</a>
          </div>
            ...
            <div class="card ">
              ...
              <div class="card-body ">
               ...
               <?php
                ...
                $codigo=$_GET['cod'];
                $link = conectarse();
                $sql= "SELECT * from guiaremision WHERE guiaremision.codigoguiaremision= '$codigo'";
                ...
                ?>           
                    ...
                    <input type="text" class="form-control" name="fechatraslado"  value="<?php echo $campo['fechatraslado']?>"/ required>                
                    </div>

                    <div class="form-group">
                    <label for="puntopartida">Punto de Partida</label>
                    <input type="text" class="form-control" name="puntopartida" value="<?php echo $campo['puntopartida']?>"/ required>                  
                    </div>
                 
                    <div class="form-group">
                    <label for="puntollegada">Punto de Llegada</label>
                    <input type="text" class="form-control" name="puntollegada" value="<?php echo $campo['puntollegada']?>"/ required>                  
                    </div>

                    <div class="form-group">
                    <label for="motivotraslado">Motivo Traslado</label>
                    <input type="text" class="form-control" name="motivotraslado" value="<?php echo $campo['motivotraslado']?>"/ required>                  
                    </div>

                    <div class="form-group">
                      <label>Nombre de los Accesorios</label>
                      <textarea class="form-control" name="nombreaccesorio" rows="3" equired> <?php echo $campo['nombreaccesorio']?></textarea>
                    </div>
                    
                    <div class="form-group">
                    <label for="responsabletraslado">Responsable del Traslado</label>
                    <input type="text" class="form-control" name="responsabletraslado" value="<?php echo $campo['responsabletraslado']?>"/ required>                  
                    </div>
                    ...
                    <center>
                        ...
                        <input class="btn btn-primary" type="submit" value="Acctualizar Guia Remision" name="enviar">
