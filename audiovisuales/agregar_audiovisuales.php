...
<!-- CONTENIDO -->
            <div class="card ">
              ...
              <div class="card-body ">
                    ...
                    <textarea class="form-control" name="equipoproduccion" rows="3"  placeholder="Ingrese a los integrantes de la produccion" required></textarea>
                    </div>
                      
                    <div class="form-group">
                    <label for="produccion">Produccion</label>
                    <input type="text" class="form-control" name="produccion" placeholder="Ingrese nombre del trabajo" required>                  
                    </div>

                    <div class="form-group">
                    <label for="genero">Genero</label>
                    <input type="text" class="form-control" name="genero" placeholder="Ingrese nombre del genero de la produccion" required>                  
                    </div>
                 
                    <div class="form-group">
                    <label for="Profesor">fecha</label>
                    <input type="date" class="form-control" name="fechaproduccion" placeholder="Ingrese fecha" required>                  
                    </div>

                    <div class="form-group">
                      <label>Sinopsis</label>
                      <textarea class="form-control" name="sinopsis" rows="3"  placeholder="Ingrese la Sinopsis de la produccion" required></textarea>
                    </div>

                    
                    <div class="custom-file">                  
                      <input type="file" class="custom-file-input" name="video" lang="es" required>
                    ...
                    <div class="form-group">
                        ...
                        <input class="btn btn-primary" type="submit" value="Registrar Nuevo Producto" name="enviar">
                        </td>
                    </div>
