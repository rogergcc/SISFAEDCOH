...
$query = "SELECT a.codigoaudiovisual, c.nombrecurso, p.nombreprofesor, a.equipoproduccion, a.produccion, a.genero,  a.fechaproduccion, a.sinopsis ,a.video, a.estado FROM audiovisual AS a INNER JOIN curso AS c INNER JOIN profesor AS p ON a.codigocurso=c.codigocurso and a.codigoprofesor=p.codigoprofesor";
  ...
  while($row = $resultado->fetch_assoc())
  {
    ...
    $pdf->Cell(20,6,utf8_decode($row['nombrecurso']),1,0,'C');
    $pdf->Cell(20,6,utf8_decode($row['nombreprofesor']),1,0,'C');
